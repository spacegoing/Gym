...
| Turing Vif                 | <a href='resources_servers/turing_vif/configs/turing_vif.yaml'>turing_vif.yaml</a>                                                          | instruction_following | -                                                                                                                                                              | Turing VIF instruction following validators with rule-based and LLM judge support                          | Improve instruction following capabilities with comprehensive validation | -     | -          | -                                                         |
